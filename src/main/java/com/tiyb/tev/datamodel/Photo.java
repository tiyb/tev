...
public class Photo implements Serializable, TEVCommonItems<Photo> {
    ...
    /**
     * Photo's URL from Tumblr; in TEV, this field is typically ignored, if there is
     * a 1280 URL
     */
    ...
    /**
     * "Offset" of this photo within the series; in other words, the order in which
     * this photo should appear.
     */
    ...
    /**
     * Constructor with suppliable values (not including <code>id</code>, since that is auto-generated by the DB)
     * @param postId ID of the parent post
     * @param caption Photo caption
     * @param photoLinkUrl URL to photo on Tumblr
     * @param offset Offset of the photo in the series
     * @param width Width
     * @param height Height
     * @param url1280 URL to the 1280 size of the photo in Tumblr
     * @param url500 URL to the 500 size of the photo in Tumblr
     * @param url400 URL to the 400 size of the photo in Tumblr
     * @param url250 URL to the 250 size of the photo in Tumblr
     * @param url100 URL to the 100 size of the photo in Tumblr
     * @param url75 URL to the 75 size of the photo in Tumblr
     */
    @SuppressWarnings("checkstyle:parameternumber")
    public Photo(final String postId, final String caption, final String photoLinkUrl, final String offset,
            final Integer width, final Integer height, final String url1280, final String url500, final String url400,
            final String url250, final String url100, final String url75) {
        this.postId = postId;
    ...
    /**
     * Helper function to update properties of the object from another copy of the
     * object. Ignores ID and Post ID.
     *
